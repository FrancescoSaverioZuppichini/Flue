...
class SuperStore extends Store {
  ...
  /**
   * This function takes a function that returns 
   * an object of actions call in order to add them
   * to the global store and make them available from anywhere.
   * Example:
   * 
   * ```javascript
   * 
   ...
   * using SuperStore.addStore(Store)
   * @param {Store} store 
   */
  ...
  /**
  * This function add Store to the global SuperStore,
